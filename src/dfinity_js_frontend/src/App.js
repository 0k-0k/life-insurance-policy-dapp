...
import coverImg from "./assets/img/life2.jpg";
import bgImage from "./assets/img/life.jpg"; // Import the correct image
import { login, logout as destroy } from "./utils/auth";
import { getDfxAddress, balance as principalBalance } from "./utils/ledger";
import Cover from "./components/utils/Cover";
import { Notification } from "./components/utils/Notifications";
import Policies from "./components/policy-reservation/Policies";
      ...
      <>
        ...
        {isAuthenticated ? (
          <Container fluid="md">
            ...
            <main>
              <Policies fetchBalance={getBalance} />
            </main>
          </Container>
        ) : (
          <Cover
            name={"Ensure Your Life Now"}
            login={login}
            coverImg={coverImg}
          />
        )}
